...
const generateMessageId = (idx: number): string => `0x${'a'.repeat(60)}${idx.toString(16).padStart(4, '0')}`
...
export const MOCK_ADDRESS_DATA: AddressResponse = {
	...
	data: Array.from({ length: 20 }, (_, i) => {
		...
		return {
			...
			type: [TransactionType.CanonicalBridge, TransactionType.IOUBridge, TransactionType.Message][idx % 3],
