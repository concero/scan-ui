...
export const DesktopVisuals = (): ReactElement => {
	...
	return (
		<motion.div className="desktop_visuals" data-theme={theme} variants={container} initial="hidden" animate="show">
				...
				<motion.img
					...
					whileHover={
						className === 'visual_three'
							...
							: {
									rotate: 0,
									transition: { type: 'spring', stiffness: 600, damping: 15, mass: 1, delay: 0 },
								}
					}
				/>
			))}
