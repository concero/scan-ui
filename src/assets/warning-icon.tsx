...
export const WarningIcon = ({ color = '#66767D' }: WarningIconProps) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
			...
			<rect
				...
				height="1.6"
				rx="0.8"
				transform="rotate(90 8.80005 6.40002)"
				fill={color}
			/>
			<rect x="8.80005" y="4" width="1.6" height="1.6" rx="0.8" transform="rotate(90 8.80005 4)" fill={color} />
		</svg>
	)
}
